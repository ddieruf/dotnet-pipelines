...
export APP_SRC_CSPROJ_PATH="${ARTIFACT_ROOT}/${SRC_AND_TEST_RESOURCE}/${APP_SRC_CSPROJ_PATH}"
export APP_UNIT_TEST_CSPROJ_PATH="${ARTIFACT_ROOT}/${SRC_AND_TEST_RESOURCE}/${APP_UNIT_TEST_CSPROJ_PATH}"
export APP_INTEGRATION_TEST_CSPROJ_PATH="${ARTIFACT_ROOT}/${SRC_AND_TEST_RESOURCE}/${APP_INTEGRATION_TEST_CSPROJ_PATH}"
export APP_SMOKE_TEST_CSPROJ_PATH="${ARTIFACT_ROOT}/${SRC_AND_TEST_RESOURCE}/${APP_SMOKE_TEST_CSPROJ_PATH}"
export CF_MANIFEST_PATH="${ARTIFACT_ROOT}/${SRC_AND_TEST_RESOURCE}/${CF_MANIFEST_PATH}"
export ARTILLERY_MANIFEST_PATH="${ARTIFACT_ROOT}/${SRC_AND_TEST_RESOURCE}/${ARTILLERY_MANIFEST_PATH}"
